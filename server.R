...
shinyServer(function(input, output) {
  ...
  output$plot <- renderPlot({
    ...
    points(x, y, pch = 16, cex = 0.8, col = "red",,xlab ="Explanatory Variable" ,ylab = "Dependent Variable")
    title("Linear Regression of Ames Home Price vs. Selected Explanatory Variable")
